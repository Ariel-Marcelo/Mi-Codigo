...
const countdown = (deadline, elem, finalMessage) => {
    ...
    const timerUpdate = setInterval( () => {      // La función timerUpdate recibe 2 parametros una funcion que sera ejecutada cada cierto intervalo de tiempo definido por el segundo parámetro
        ...
        el.innerHTML = t.remainDays + 'd : ' + t.remainHours + 'h : ' + t.remainMinutes + 'm : ' + t.remainSeconds + "s";    // innerHTML nos da la facilidad de cabiar nuestro texto y el HTML con gran facilidad lo que nos permite tener paginas mas interactivas que cambien segun como interactue el usuario con ellas .
